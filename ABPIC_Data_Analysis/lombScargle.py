...
if __name__ == '__main__':
    ...
    for orbit in [10, 11, 12]:
        df125.loc[df125['ORBIT'] == orbit, 'Normed Flux'] = df125[df125['ORBIT'] == orbit]['FLUX']/df125[df125['ORBIT'] == orbit]['FLUX'].mean()

    t = (df125.index.values - df125.index.values[0]).astype(float)/(60.*1e9) # t in min
