...
# gc.show_colorscale(cmap = 'hot', interpolation = 'bicubic',vmin=-50, vmax = 2000, stretch = 'arcsinh')
# ax = plt.gca()
# ax.set_xlim([44, 184])
# ax.set_ylim([98, 238])
...
#ax.contourf(xx, yy, mask, 3, colors = [(0,0,0,0), '0.2', '0.3'], hatches = ['o', None, None], alpha = 0.5, antialiased = True)
