...
def pyTinyTim(xc, yc, filterName, jitx=0, jity=0, secDis=0, outputRoot = None, outputDIR = '.'):
    """
    ...
    if outputRoot is None:
        outputRoot = 'Jitx_{0:0>2d}_Jity_{1:0>2d}_Dis_{2:0>2.2f}_x_{3:d}_y_{4:d}_'.format(jitx, jity, secDis, xc, yc)

    ### Modify the configuration file
    inFile = open('/Users/ZhouYf/Documents/Exoplanet-Patchy-Clouds/python_src/2mass_psf.in', 'r').readlines()
    inFile[1] = outputRoot + '\n'
    inFile[7] = '{0}  # Filter\n'.format(filterName)
    ...
    FNULL.close()
    print outputRoot, '00.fits generated'
    psf_fn = inFile[1].strip()+'00_psf.fits'
    tt3_fn = inFile[1].strip()+'.tt3' # two auxiliary files generated by PSF, remove these two files to keep the working directory clean
