...
if __name__ == '__main__':
    ...
    ax_p.set_title('Probability Distribution: Period')
    ...
    countAmp125 = countAmp125 / countAmp125.max()
    countAmp160 = countAmp160 / countAmp160.max()
    binAmp125 = binAmp125 * 100
    binAmp160 = binAmp160 * 100
