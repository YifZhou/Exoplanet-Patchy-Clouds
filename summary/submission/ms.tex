...
\bibitem[{Bonnefoy {et~al.}(2014)}]{Bonnefoy2014}
Bonnefoy, M., Chauvin, G., et al. 2014, A\&A, 562, A127

\bibitem[{Buenzli {et~al.}(2012)}]{Buenzli2012}
Buenzli, E., Apai, D., et al. 2012, ApJ, 760, L31

\bibitem[{Buenzli {et~al.}(2015)}]{Buenzli2015}
Buenzli, E., Saumon, D., et al. 2015, ApJ, 798, 127


\bibitem[{Burrows {et~al.}(2006)}]{Burrows2006a}
Burrows, A., Sudarsky, D., \& Hubeny, I. 2006, ApJ, 640, 1063

\bibitem[{{Chauvin} {et~al.}(2004)}]{Chauvin2004}
{Chauvin}, G., {Lagrange}, A.-M., et al. 2004, \aap, 425, L29

\bibitem[{{Chauvin} {et~al.}(2005)}]{Chauvin2005}
---. 2005, \aap, 438, L25
...
\bibitem[{Ducourant {et~al.}(2008)}]{Ducourant2008}
Ducourant, C., Teixeira, R., et al. 2008, \aap, 477, L1

\bibitem[{{Heinze} {et~al.}(2015)}]{Heinze2015}
{Heinze}, A.~N., {Metchev}, S., \& {Kellogg}, K. 2015, \apj, 801, 104

\bibitem[{Helling {et~al.}(2008)}]{Helling2008}
Helling, C., Ackerman, A., Allard, F., et al. 2008,
  MNRAS, 391, 1854

\bibitem[{{Klein} {et~al.}(2003)}]{Klein2003}
...
\bibitem[{Kreidberg {et~al.}(2014)}]{Kreidberg2014}
